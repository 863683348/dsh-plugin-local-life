...
function apply(ctx, config) {
  ctx.tools.register(defineTool({
    ...
    parameters: {
      ...
      products: { type: "array", items: { type: "object" }, description: "Products [{name, price, quantity, unit}] (compare unit prices)." },
      discounts: { type: "array", items: { type: "object" }, description: "Discounts [{pct} | {amount} | {threshold, pct|amount}] (compare stacking)." },
      ...
      ingredients: { type: "array", items: { type: "object" }, description: "Ingredients [{name, quantity, unitPrice, unit}] (recipe_cost)." },
    },
    output: {
      schema: {
        type: "object",
